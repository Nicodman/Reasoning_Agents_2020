...
def _make_cmd(ep, rs, otf, goal):
    ...
    s = "data/chess_" + "__".join([a + "_" + b for a, b in zip(keys, map(str, [ep, rs, otf, main_goal_string]))])
    experiment_string = "--episodes {} --gamma 1.0 --verbosity 0 {} {} --datadir {} chess --temp_goal {}" \
