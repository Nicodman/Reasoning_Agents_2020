...
'''
#########
# only positive rewards  ---> rew per rbù
...
class RewardAutoma(object):
    ...
    def update(self, a=None): # last action executed
        ...
        if (self.RAnode != self.RAFail):
            ...
            TOKENS = [ ['c1', 'green', 0, 1],  ['c2', 'green', 0, 2],   ['c3', 'green', 0, 3],  ['c4', 'green', 1, 3],
                       ['t1', 'blue', 1, 0],   ['t2', 'blue', 2, 0],    ['t3', 'blue', 3, 0],   ['t4', 'blue', 4, 0],
                       ['r1', 'purple', 5, 1], ['r2', 'purple', 6, 2],  ['r4', 'purple', 5, 3], ['r4', 'purple', 5, 2],
                       ['a1', 'grey', 4, 4],   ['a2', 'grey', 3, 3],    ['a3', 'grey', 2, 2],   ['a4', 'grey', 1, 1]
                       ['q1', 'black', 6, 4],  [ 'q2', 'black', 5, 4],  ['q3', 'black', 4, 3],  ['q4', 'black', 3, 2]
            ]
            """

#nb qui c'e la verifica che i reward delle rb sono aggiunte a quelle dell env
