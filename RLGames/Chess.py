...
class ChessExt(Chess):
    ...
    def getSizeStateSpace(self):
        self.origns = super(ChessExt, self).getSizeStateSpace()
        # all color status
        self.bip_ns = 2
    ...
    def getstate(self):
        x = super(ChessExt, self).getstate()
        f = 1
        if self.command == 4:
            bx = 1
        else:
...
class ChessExt2(Chess):
    ...
    def getSizeStateSpace(self):
        self.origns = super(ChessExt2, self).getSizeStateSpace()
        # all color status
    ...
    def getstate(self):
        x = super(ChessExt2, self).getstate()
        f = 1
        tx = 0
